...
export default function PdfMake({
  ...
  const sumProductsFormated = produtos => {
    const mapProducts = produtos.map(produto => produto.value);
    const sumProducts = mapProducts.reduce((a, b) => a + b);
    return (sumProductsFormated = sumProducts.toLocaleString("pt-br", {
      style: "currency",
      currency: "BRL"
    }));
  };

  // const mapPayments = produtos.map(produto => produto.value);
      ...
      },
      {
        table: {
          ...
          body: [
            [
              {
                text: values.info_ad_hidraulico
              }
            ]
          ]
        }
      ...
      "\n",
      {
        table: {
          ...
          body: [
            ...
            [
              { text: "1", style: "centerLine" },
              { text: "16/10/2019", style: "centerLine" },
              { text: "Boleto", style: "centerLine" },
              { text: "R$ 10.000,00", style: "centerLine" }
            ],
            [
              { text: "2", style: "centerLine" },
              { text: "16/10/2019", style: "centerLine" },
              { text: "Boleto", style: "centerLine" },
              { text: "R$ 10.000,00", style: "centerLine" }
            ],
            [
              { text: "3", style: "centerLine" },
              { text: "16/10/2019", style: "centerLine" },
              { text: "Boleto", style: "centerLine" },
              { text: "R$ 10.000,00", style: "centerLine" }
            ],
            [
              { text: "4", style: "centerLine" },
              { text: "16/10/2019", style: "centerLine" },
              { text: "Boleto", style: "centerLine" },
              { text: "R$ 10.000,00", style: "centerLine" }
            ],
            [
              { text: "5", style: "centerLine" },
              { text: "16/10/2019", style: "centerLine" },
              { text: "Boleto", style: "centerLine" },
              { text: "R$ 10.000,00", style: "centerLine" }
            ],
            [
              { text: "6", style: "centerLine" },
              { text: "16/10/2019", style: "centerLine" },
              { text: "Boleto", style: "centerLine" },
              { text: "R$ 10.000,00", style: "centerLine" }
            ]
  ...
  const PdfGenerator = () => {
    if (!values.vendedor || !values.natureza_operacao) {
      setErrors("Preencha todos os dados obrigatórios do vendedor!");
    } else if (
      !cliente ||
      !values.nome_contato ||
      !values.cargo_contato ||
      ...
      setErrors("Preencha todos os dados obrigatórios do cliente!");
    } else if (produtos.length <= 0) {
      setErrors("Preencha os produtos!");
    } else {
      setErrors();
...
/* LAYOUT
{
        columns: [
          ...
          },
          {
            table: {
                widths: [100],
    			body: [
    				[{text:'Nº DO PEDIDO', alignment: 'center', bold: true, fontSize: 5, fillColor: '#dddddd'}],
    				[{text:'12315', alignment: 'center', fontSize: 5}],
    				[{text:'DATA DO PEDIDO', alignment: 'center', bold: true, fontSize: 5, fillColor: '#dddddd'}],
    				[{text:'56454', alignment: 'center', fontSize: 5}],
    				[{text:'Nº DE SÉRIE', alignment: 'center', bold: true, fontSize: 5, fillColor: '#dddddd'}],
    				[{text:'45646', alignment: 'center', fontSize: 5}],
    			],
    		align: "center"
			}
          }
      ...
      },
      {
        table: {
            widths: "*",
			body: [
				[{text:'DADOS DO CLIENTE', alignment: 'center', bold: true, colSpan: 2, fontSize: 9, fillColor: '#dddddd'},{}],
				[{text:[
			        {text:"Razão Social: ", bold: true},
                    "A FACIO FERRO E CIA LTDA ME",
                    {text:"\nCNPJ: ", bold: true},
                    "04477294000106",
                    ...
                    {text:"\nTelefone: ", bold: true},
                    "(11) 968497823",
                    {text:"\nNome do contato: ", bold: true},
                    "ALEXANDRE",
                    {text:"\nCargo do contato: ", bold: true},
                    "Gerente",
                    {text:"\nEmail: ", bold: true},
                    "AFACIOFERRO@HOTMAIL.COM",
				    ]},
				{text:[
			        {text:"CÓDIGO: ", bold: true},
                    "000004",
                    {text:"\nEndereço: ", bold: true},
                    "ESTR MUN LUCIANO ROCHA PECANHA, 1515",
                    {text:"\nBairro: ", bold: true},
                    "SP",
                    {text:"\nMunicípio: ", bold: true},
                    "ATIBAIA",
      ...
      "\n",
      {
        table: {
            widths: [60,"*",60,30,80,80],
			body: [
				[{text:'PRODUTOS', alignment: 'center', bold: true, colSpan: 6, fontSize: 9, fillColor: '#dddddd'},{},{},{},{},{}],
				[
				{text:"CÓDIGO", style: "centerHeader"},
				{text:"PRODUTO", style: "centerHeader"},
				{text:"GRUPO", style: "centerHeader"},
				...
				[
				{text:"78SHR2303Z1", style: "centerLine"},
				{text:"CACAMBA GRANITEIRA", style: "centerLine"},
				{text:"0070", style: "centerLine"},
				{text:"1", style: "centerLine"},
				{text:"R$ 10.000,00", style: "centerLine"},
				{text:"R$ 10.000,00", style: "centerLine"},
				],
   ...
   },
   {
    ...
    },
    {
        table: {
            widths: "*",
			body: [
				[{text:'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Confectum ponit legam, perferendis nomine miserum, animi. Moveat nesciunt triari naturam posset, eveniunt specie deorsus efciat sermone instituendarum fuisse veniat, eademque mutat debeo. '}],
			],
		},
    },
    "\n",
    {
        table: {
			...
			body: [
				[
				{text:'KIT HIDRÁULICO', alignment: 'center', colSpan: 3, bold: true, fontSize: 9, fillColor: '#dddddd'},{},{},],
				[{text:[
                    "Kit Lubrificação","\n",
				...
				{text:[
                    ...
                    "SIM","\n",
                    {text:"INFORMAÇÕES RELEVANTES: ", bold: true},
                    "Sem predisposição no comando (TAB1- Fig 3)","\n",
                    {text:"TIPO DE PONTEIRA: ", bold: true},
                    "Universal","\n\n",
                    {text:"PONTEIRA EXTRA: ", bold: true},
                    "SIM","\n",
				...
				{text:[
				    {text:"USO EXCLUSIVO PARA ROMPEDORES HIDRÁULICOS: ", bold: true},
                    "Condição Padrão: Uma Caixa Ferramenta Completa com Kit Nitrogênio, Um Cilindro de Gás, Um Par de Mangueiras, Um Manual de Peças, Um Manual de Operação e Uma Ponteira.","\n",
				    ]}
				],
    ...
    "\n",
    {
        table: {
            widths: "*",
			body: [
				[{text:'FINANCEIRO', alignment: 'center', bold: true, colSpan: 4, fontSize: 9, fillColor: '#dddddd'},{},{},{}],
				[
				{text:"PARCELA", style: "centerHeader"},
				{text:"DATA", style: "centerHeader"},
				{text:"FORMA DE PAGTO", style: "centerHeader"},
